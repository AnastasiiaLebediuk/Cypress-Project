...
describe ("Positive registration tests", ()=>{
    ...
    it("Positive test result with max data length", ()=>{
    ...
    it("Positive test result with minimum data length", ()=>{
        homePage.button.click();
...
describe ("Negative registration tests", ()=>{
    ...
    it("Incorrect language of the name", ()=>{
    ...
    it("Password in capital letters", ()=>{
        homePage.button.click();
    ...
    it("Password in lowercase letters", ()=>{
        homePage.button.click();
